...
class SaveTrigger(str,Enum): INITIAL_STATE_CREATED="INITIAL_STATE_CREATED"; STATE_TRANSITION="STATE_TRANSITION"; REASON_CHANGED="REASON_CHANGED"; METRIC_CHANGED="METRIC_CHANGED"; PERIOD_ROLLOVER="PERIOD_ROLLOVER"; ACCOUNTING_REBASE="ACCOUNTING_REBASE"; LOCKED="LOCKED"; RECOVERY_COMPLETED="RECOVERY_COMPLETED"; RUNTIME_SHUTDOWN="RUNTIME_SHUTDOWN"; MANUAL_CHECKPOINT="MANUAL_CHECKPOINT"; NONE="NONE"
...
def build_save_trigger_decision(trigger,state_changed=False):
 ...
 req=t is not SaveTrigger.NONE and (state_changed or t in (SaveTrigger.INITIAL_STATE_CREATED,SaveTrigger.PERIOD_ROLLOVER,SaveTrigger.ACCOUNTING_REBASE,SaveTrigger.LOCKED,SaveTrigger.RUNTIME_SHUTDOWN,SaveTrigger.MANUAL_CHECKPOINT))
