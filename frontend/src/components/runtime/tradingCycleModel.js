const STAGES = [
    ...
    { index: 11, key: 'settlement', label: 'Settlement / Exit Execution', japanese: '決済' },
    { index: 12, key: 'positionClosed', label: 'Position Closed', japanese: 'ポジションクローズ' },
    { index: 13, key: 'performanceRecord', label: 'Trade / Parameter Performance Record', japanese: 'パフォーマンス記録' },
